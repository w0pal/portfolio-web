...
const output = `// Generated by scripts/fetch-medium.mjs
import type { BlogPost } from './blog-posts'

export const mediumPosts: BlogPost[] = ${JSON.stringify(posts, null, 2)}
`

writeFileSync(resolve(process.cwd(), 'src/data/medium-posts.ts'), output, 'utf-8')
